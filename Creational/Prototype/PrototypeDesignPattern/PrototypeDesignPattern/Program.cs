/*
 * Citation: https://refactoring.guru/design-patterns/prototype/csharp/example
 */
...
namespace PrototypeDesignPattern
{
    class Program
    {
        public class Person : ICloneable
        {
            ...
            /// <summary>
            /// This does the shallow cloning and instanciates new object for the IdInfo property
            /// </summary>
            /// <returns></returns>
            public Person DeepCopy()
            {
                ...
                clone.Name = Name; // strings live on the heap.
                return clone;
            }
        }
